...
router.delete('/delete-by-party/:partyName', auth.authMiddleware, entriesController.deleteByParty);
router.put('/update-by-party/:partyName', auth.authMiddleware, entriesController.updateByParty);
